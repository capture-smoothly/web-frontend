            ...
            <div style={{ display: "flex", gap: "4px" }}>
              ...
              {[
                ...
                <TooltipButton
                  ...
                  tooltip={tool.charAt(0).toUpperCase() + tool.slice(1)}
                  tooltipBg={colors.tooltipBg}
                  tooltipText={colors.textSecondary}
                  tooltipBorder={colors.border}
                  style={{
                    ...
                    cursor: "pointer",
                    backgroundColor:
                      activeTool === tool ? "#3B82F6" : colors.buttonBg,
                    color: activeTool === tool ? "white" : colors.textMuted,
                    border: "none",
                    borderRadius: "6px",
                  }}
                >
                  ...
                  {tool === "blur" && (
                    ...
                    >
                      ...
                      <rect x="6" y="2" width="4" height="4" opacity="0.5" />
                      <rect x="10" y="2" width="4" height="4" opacity="0.3" />
                      <rect x="2" y="6" width="4" height="4" opacity="0.5" />
                      <rect x="6" y="6" width="4" height="4" opacity="0.7" />
                      <rect x="10" y="6" width="4" height="4" opacity="0.5" />
                    </svg>
                  )}
                  {tool === "freehand" && (
                    <svg
                      ...
                      strokeWidth="1.5"
                    >
                      <path d="M2 10c2-4 4-6 6-4s4 1 6-4" />
                    </svg>
                  )}
                </TooltipButton>
              ))}
