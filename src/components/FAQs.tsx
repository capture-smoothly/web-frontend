...
const items = [
  ...
  },
  {
    ...
    answer:
      "Our pricing is per user, per month. This means you only pay for the number of users you have team members you have on your account. Discounts are available for larger teams  and annual subscriptions.",
  },
  {
