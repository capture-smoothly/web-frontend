...
export const metadata: Metadata = {
  ...
  description: "The only Chrome extension that turns your copied text into beautiful, shareable images. Plus revolutionary two-point selection that never loses your place. 100+ Premium Themes, Smart Text Selection, Professional Editing.",
  ...
  openGraph: {
    title: "ILoveSnapshots - Professional Screenshot & Content Capture Tool",
    description: "Create stunning screenshots & text snapshots in seconds. 100+ Premium Themes, Smart Text Selection, Professional Editing.",
    type: "website",
    locale: "en_US",
